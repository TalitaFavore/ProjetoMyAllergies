 ...
 * @author Talita
 */
@WebServlet(name = "SensitivityListar", urlPatterns = {"/SensitivityListar"})
public class SensitivityListar extends HttpServlet {
     ...
     */
        ...
        try{
           ...
           request.setAttribute("sensitivities", dao.listar());
