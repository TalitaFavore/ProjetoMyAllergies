 ...
 * @author Talita
 */
@WebServlet(name = "SensitivityNovo", urlPatterns = {"/SensitivityNovo"})
public class SensitivityNovo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("sensitivity", oSensitivity);
